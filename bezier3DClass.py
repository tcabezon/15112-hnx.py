...
#Bezier class, uses a control point list to generate a plain bezier curve that then is rotated along the z axis
#to generate a 3D model. Methods on this clase include:
# the point and faces matrix generator, 
# De Casteljau recursive algorithm: to generate the points in the bezier curve given the control points,
# bezier mesh generator,
# mesh display and
# mesh save
