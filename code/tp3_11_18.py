...
def appStarted(app):
    ...
    app.ring=Ring(200,10,stepRing=15,stepCircunference=3)
    app.draw=True
...
def bezier_redrawAll(app, canvas):
    ...
    editionWindow(canvas,app)
    canvas.create_text(app.width-app.margin, app.height-app.margin,
                       text='The first and last point in the curve are automatically placed. If you want them in a different position, you can move them', font='Arial 10 bold', anchor='se')
