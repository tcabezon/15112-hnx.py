...
# Sphere class, generates an sphere with a given radious and a given center. 
# The number of subdivisions on the mesh can be specified with the stepU and stepV variables.
# Methods on this clase include:
# the point and faces matrix generator and
# mesh generator
