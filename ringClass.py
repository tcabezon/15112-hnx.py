...
# Ring class, uses the diameter and profile circunference parameters to generate the ring
# basic ring mesh generator
# circunference generator
# add element method to include the sphere and bezier3D elements into the mesh of the ring
